...
```{r include=FALSE}
# PHV
opptaksomrader_phv_rhf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-phv-rhf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

opptaksomrader_phv_hf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-phv-hf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

# TSB
opptaksomrader_tsb_rhf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-tsb-rhf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

opptaksomrader_tsb_hf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-tsb-hf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

# DPS
opptaksomrader_dps_rhf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-dps-rhf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

opptaksomrader_dps_hf <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-dps-hf-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)

opptaksomrader_dps_dps <- sfarrow::st_read_parquet(paste0(arbeidsmappe_opptak, "opptaksomrader-dps-lokasjon-flate_p", aargang, ".parquet")) %>%
  sf::st_transform(4326)
```
